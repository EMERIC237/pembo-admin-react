      ...
      <Scrollbar>
        ...
        <Stack direction="row" spacing={2} sx={{ mb: 2 }}>
            ...
            >
              ...
              {items.flatMap(item => item.categories.map(cat => cat.name))
              ...
              {items.map((product) => {
                ...
                return (
                  <TableRow hover key={product.id}>
                    ...
                    <TableCell>
                      {product.averageReviewRating.toFixed(1)}
                    </TableCell>
                    <TableCell>
                      {status}
                    </TableCell>
                    <TableCell>
                      ...
                      <Menu
                        ...
                        onClose={handleClose}
                      >
                        <MenuItem onClick={() => { onEdit(selectedProduct); handleClose(); }}>Edit</MenuItem>
                        <MenuItem onClick={() => { onDelete(selectedProduct); handleClose(); }}>Delete</MenuItem>
                      </Menu>
                    </TableCell>
                  </TableRow>
                );
